...
<head>
    ...
    <style>
        ...
        input[type="text"], input[type="email"], input[type="tel"], input[type="password"], input[type="date"], select, input[type="file"] {
            width: 100%;
            padding: 8px;
            margin-top: 5px;
            box-sizing: border-box;
            border: 1px solid #755405;
        }
        button {
            width: 100%;
            padding: 10px;           
...
<nav>
    ...
    <a href="Tienda de Mueble.html"><button>Volver</button></a>
    </div>
