    ...
    <div class="container" id="products-container">
            ...
            <div class="article" >
                <div class="article-content">
                    <img src="mesas1.jpg" alt="Producto 1"  width="80%" onclick="window.location.href='mesas1.html'">
                    <div class="article-title">Seccional Decohome Alba</div>
                    <div class="article-description">Este seccional ha sido fabricado siguiendo rigurosos estándares de la mejor calidad, los cuales te brindarán un amplio confort durante su uso.</div>
                    <div class="article-price">Precio: $60.00</div>
                    <button class="add-to-cart-btn" data-name="Seccional Decohome Alba" data-price="150" data-image="mesas1.jpg">Añadir al Carrito</button>
                </div>
            </div>
        ...
        <div class="article" >
            <div class="article-content" >
                <img src="mesas2.jpg" alt="Producto 2" width="80%" onclick="window.location.href='mesas2.html'">
                <div class="article-title">Poltrona Fossvelen de Tela Gris</div>
                <div class="article-description">Poltrona Fossvelen de un estilo industrial. Tapizado en una tela color gris con un diseño de espiga, su estructura metálica es color negro mate.</div>
                 <div class="article-price">Precio: $60.00</div>
                <button class="add-to-cart-btn" data-name="Poltrona Fossvelen Tela Gris" data-price="150" data-image="mesas2.jpg">Añadir al Carrito</button>
            </div>
        </div>

        <div class="article" >
            <div class="article-content">
                <img src="mesas3.jpg" alt="Producto 3" width="80%" onclick="window.location.href='mesas3.html'">
                <div class="article-title">Sofa Rosen Kingsgate</div>
                <div class="article-description">Diseño estilo clásico, que se realza por el tradicional brazo Roller, Respaldo alto potencial confortabilidad ya que otorga una sujeción óptima. Patas de madera abedul</div>
                 <div class="article-price">Precio: $60.00</div>
                <button class="add-to-cart-btn" data-name="Sofa Rosen Kingsgate" data-price="150" data-image="mesas3.jpg">Añadir al Carrito</button>
            </div>
        </div>

        <div class="article">
            <div class="article-content">
                <img src="mesas4.jpg" alt="Producto 4" width="80%" onclick="window.location.href='mesas4.html'">
                <div class="article-title">Juego De Sala, Sofá Hogar Color Marfil</div>
                <div class="article-description">Mueble de sala Francy 2024 tapizado en tela terciopelo, de fácil limpieza y tacto suave. Construido con estructura de madera nacional y patas de metal cromado, ofrece durabilidad y estabilidad.</div>
                 <div class="article-price">Precio: $60.00</div>
                <button class="add-to-cart-btn" data-name="Juego De Sala, Sofá Hogar Color Marfil" data-price="150" data-image="mesas4.jpg">Añadir al Carrito</button>
            </div>
        </div>
